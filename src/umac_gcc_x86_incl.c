...
static void RC6(UINT32 S[], void *pt, void *ct) {
  ...
  asm volatile(
      ...
      RC6_BLOCK(edi, ebx, ebp, edx, 0) RC6_BLOCK(
          ebx, ebp, edx, edi, 8) RC6_BLOCK(ebp, edx, edi, ebx,
                                           16) RC6_BLOCK(edx, edi, ebx, ebp, 24)

          RC6_BLOCK(edi, ebx, ebp, edx, 32) RC6_BLOCK(ebx, ebp, edx, edi, 40)
              RC6_BLOCK(ebp, edx, edi, ebx, 48) RC6_BLOCK(edx, edi, ebx, ebp,
                                                          56)

                  RC6_BLOCK(edi, ebx, ebp, edx, 64) RC6_BLOCK(
                      ebx, ebp, edx, edi, 72) RC6_BLOCK(ebp, edx, edi, ebx, 80)
                      RC6_BLOCK(edx, edi, ebx, ebp, 88)

                          RC6_BLOCK(edi, ebx, ebp, edx, 96) RC6_BLOCK(
                              ebx, ebp, edx, edi, 104)
                              RC6_BLOCK(ebp, edx, edi, ebx, 112) RC6_BLOCK(
                                  edx, edi, ebx, ebp, 120)
...
/* optimize by unrolling the loop. 64 bits are written at hp.             */
{
  ...
  asm volatile(
      ...
      NH_BLOCK(0) NH_BLOCK(4) NH_BLOCK(8) NH_BLOCK(12) NH_BLOCK(32) NH_BLOCK(36)
          NH_BLOCK(40) NH_BLOCK(44)
      ...
      NH_BLOCK(0) NH_BLOCK(4) NH_BLOCK(8) NH_BLOCK(12)
...
/* toeplitz shift of the first.                                           */
{
  ...
  asm volatile(
      ...
      MMX_BLOCK_32(0) MMX_BLOCK_32(32) MMX_BLOCK_32(64) MMX_BLOCK_32(96)
...
/* toeplitz shift of the first.                                           */
{
  ...
  asm volatile(
      ...
      MMX_BLOCK_64(0) MMX_BLOCK_64(32) MMX_BLOCK_64(64) MMX_BLOCK_64(96)
...
/* toeplitz shift of the first.                                           */
{
  ...
  asm volatile(
      ...
      MMX_BLOCK_128(0) MMX_BLOCK_128(32) MMX_BLOCK_128(64) MMX_BLOCK_128(96)
...
static UINT64 poly64(UINT64 cur, UINT64 key, UINT64 data) {
  UINT32 data_hi = (UINT32)(data >> 32), data_lo = (UINT32)(data);

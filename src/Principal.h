...
class Principal {
 ...
 private:
  ...
  // Requires: "dst" can hold at least "MAC_size" bytes and "k" is Nonce_size
  // bytes. Effects: Generates a secret-suffix MAC using MD5 (RFC 1321) and "k"
  // and places it in "dst".  The MAC authenticates "src_len" bytes starting at
  // "src".
#else

...
class Principal {
 ...
 private:
  ...
  /**
   * Requires: "hmac" points to a initialized hmac context
   * Effects: Returns true iff "mac" is a valid MAC generated by
  ...
  /**
   * Requires: "dst" can hold at least "MAC_size" bytes and hmac points to a
   * initialized HMAC context.
   * Effects: Generates a UMAC and places it in "dst".  The MAC authenticates
   * "src_len" bytes starting at "src".
   */
  void gen_mac(const char *src, unsigned src_len, char *dst, Hmac &hmac);
